...
class MCPFRAMEWORK_API UMCPToolProperty : public UObject
{
    GENERATED_BODY()
...
UCLASS(BlueprintType)
class MCPFRAMEWORK_API UMCPToolPropertyString : public UMCPToolProperty
{
    GENERATED_BODY()
public:
...
UCLASS(BlueprintType)
class MCPFRAMEWORK_API UMCPToolPropertyInt : public UMCPToolProperty
{
    GENERATED_BODY()
public:
    UPROPERTY(BlueprintReadWrite, Category = "NetworkCore|MCP|Tool")
...
UCLASS(BlueprintType)
class MCPFRAMEWORK_API UMCPToolPropertyActorPtr: public UMCPToolProperty
{
    GENERATED_BODY()
public:
...
UCLASS(BlueprintType)
class MCPFRAMEWORK_API UMCPToolPropertyComponentPtr: public UMCPToolProperty
{
    GENERATED_BODY()
public:
...
UCLASS(BlueprintType)
class MCPFRAMEWORK_API UMCPToolPropertyArray: public UMCPToolProperty
{
    GENERATED_BODY()
public:
